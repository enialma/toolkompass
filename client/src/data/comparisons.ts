...
export const CATEGORIES: CategoryData[] = [
  // ── 1. Recherche ──────────────────────────────────────────────────────────
  {
    ...
    tools: {
      ...
      chatgpt: {
        scores: { zeitersparnis: 4, faktenpruefung: 3, direkteinsatz: 4, qualitaet: 3, einfachheit: 4 },
        staerken: [
        ...
        schwaechen: [
          "Websuche vorhanden, aber ohne Perplexitys gezielten Fokus auf CH-Amtsquellen (SBFI, admin.ch)",
          "Quellenlinks nur bei aktiver Websuche — weniger konsequent belegt als Perplexity",
          "Verwechselt CH-Recht gelegentlich mit EU-/DE-Recht",
          "KV-Reform-Details ohne gezielte Suche oft unvollständig",
        ],
        empfehlung: "Für Hintergrundwissen; CH-Gesetze besser mit Perplexity",
        ...
        zeitNote: "Mittlere Zeitersparnis — gut für Hintergrunderklärungen, Aktualität am besten mit gezielter Websuche und Gegenprüfung auf admin.ch.",
        faktenpruefungNote: "Hoch — trotz Websuche CH-spezifische Rechts- und SBFI-Angaben immer auf admin.ch gegenprüfen.",
      ...
      claude: {
        scores: { zeitersparnis: 4, faktenpruefung: 3, direkteinsatz: 3, qualitaet: 4, einfachheit: 4 },
        staerken: [
        ...
        schwaechen: [
          "Websuche vorhanden, aber ohne gezielten Fokus auf CH-Amtsquellen wie bei Perplexity",
          "CH-Rechtsdetails (KV-Reform, DSG) ohne gezielte Suche ggf. unvollständig",
          "Weniger konsequente CH-Amtsquellen (SBFI, admin.ch) als Perplexity",
        ],
        empfehlung: "Stärke ist die Didaktisierung, weniger die CH-Quellensuche",
  ...
  // ── 5. Dokumente analysieren ──────────────────────────────────────────────
  {
    ...
    tools: {
      ...
      chatgpt: {
        scores: { zeitersparnis: 4, faktenpruefung: 3, direkteinsatz: 4, qualitaet: 3, einfachheit: 4 },
        staerken: [
          "Kann hochgeladene oder eingefügte Dokumente gut strukturieren",
          "Erstellt Zusammenfassungen und Glossare aus den Inhalten",
          "Flexibel bei Nachfragen zu Dokumentinhalten",
          "Gute Sprachqualität für Zusammenfassungen",
        ],
        schwaechen: [
          "Datei-Upload in der freien Version limitiert (nur wenige pro Tag)",
          "Keine Querverweise zwischen mehreren Dokumenten",
          "Kann bei langen Texten den Kontext verlieren",
          "Keine Quellenansicht auf einzelne Textstellen wie NotebookLM",
        ],
        empfehlung: "Für einzelne Dokumente, nicht für Mehr-Dokument-Struktur",
        tipp: "Laden Sie das PDF hoch (oder fügen Sie Abschnitte ein): 'Fasse diesen Abschnitt aus dem Bildungsplan KV zusammen und erstelle 5 Lernziele daraus.' Für die vollständige Analyse mehrerer Dokumente NotebookLM bevorzugen.",
        zeitNote: "Mittlere Zeitersparnis — gut für einzelne Dokumente, nicht für strukturierte Mehr-Dokument-Analyse.",
      ...
      claude: {
        scores: { zeitersparnis: 4, faktenpruefung: 2, direkteinsatz: 5, qualitaet: 4, einfachheit: 4 },
        staerken: [
          ...
          "Kann Querverweise innerhalb hochgeladener oder eingefügter Texte erkennen",
        ...
        schwaechen: [
          "Keine automatische Mindmap- oder FAQ-Erstellung wie NotebookLM",
          "Keine Quellenansicht auf einzelne Textstellen wie NotebookLM",
          "Kein Audio-Format für Dokumente",
          "Weniger spezialisiert auf Mehr-Dokument-Analyse als NotebookLM",
        ],
        empfehlung: "Stark für grosse Dokumente dank langem Kontext",
